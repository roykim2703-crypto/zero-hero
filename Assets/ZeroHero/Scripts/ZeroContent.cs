...
namespace ZeroHero
{
    ...
    public static class ZeroContent
    {
        ...
        public static readonly WeaponDef[] Weapons = {
            ...
            new WeaponDef(1,"리볼버",true,34,1.6f,25,0,700,"느리고 강한 한 발",1,1,6,1.80f),
            new WeaponDef(2,"기관 단총",true,9,7.5f,18,0,1100,"짧은 간격으로 연사",1,1,30,2.15f),
            new WeaponDef(3,"산탄총",true,12,1.05f,16,0,1600,"한 번에 5발",5,1,10,2.45f),
            new WeaponDef(4,"사냥 소총",true,48,1.15f,32,0,2200,"빠른 탄환, 긴 사거리",1,1,12,2.10f),
            new WeaponDef(5,"돌격 소총",true,19,4.5f,27,0,3000,"공격 속도와 피해 균형",1,1,25,2.35f),
            new WeaponDef(6,"중 기관총",true,26,3.4f,23,0,4000,"묵직한 연속 사격",1,1,100,4.80f),
            new WeaponDef(7,"저격총",true,100,.7f,44,0,5500,"2개체 관통",1,2,5,3.80f),
            new WeaponDef(8,"쌍열 산탄총",true,18,.9f,21,0,7500,"한 번에 7발",7,1,2,.75f),
            new WeaponDef(9,"전자포",true,67,1.8f,38,0,10000,"3개체 관통 · 무한 탄창",1,3,-1,0),
            new WeaponDef(10,"녹슨 칼",false,23,2.3f,0,1.9f,0,"기본 장비"),
            new WeaponDef(11,"단검",false,17,4.2f,0,1.6f,500,"짧고 빠른 연속 베기"),
            new WeaponDef(12,"군용검",false,32,2.6f,0,2.1f,900,"가까운 적을 안정적으로 벰"),
            new WeaponDef(13,"레이피어",false,27,3.5f,0,2.5f,1400,"긴 사거리와 빠른 찌르기"),
            new WeaponDef(14,"커틀러스",false,42,2.2f,0,2.4f,2000,"빠른 중형 검"),
            new WeaponDef(15,"장검",false,54,1.7f,0,2.9f,2800,"넓은 범위의 베기"),
            new WeaponDef(16,"대검",false,85,1.0f,0,3.3f,3800,"여러 적을 한 번에 벰"),
            new WeaponDef(17,"곡도",false,40,3.2f,0,2.6f,5200,"속도를 유지한 연속 공격"),
            new WeaponDef(18,"처형검",false,130,.7f,0,3.6f,7200,"매우 느리고 강한 공격"),
            new WeaponDef(19,"흑철검",false,74,2.1f,0,3.1f,9500,"긴 칼날과 높은 피해")
        };
        ...
        public static readonly EnemyDef[] Enemies = {
            ...
            new EnemyDef(EnemyKind.Heart,"심장","박동 충격파 · 피 분사 · 혈전 소환 · 출혈 지대",1050,0,2.7f,27),
